...
class BEV_Unet(nn.Module):
    def __init__(self, n_class, n_height, dilation=1, group_conv=False, input_batch_norm=False, dropout=0.,
        ...
        :param n_height: n_height
        :param dilation: dilation
        :param group_conv: group_conv
        :param input_batch_norm: input_batch_norm
        :param dropout: dropout
        :param circular_padding: circular_padding
        :param dropblock: dropblock
        :param use_vis_fea: use_vis_fea
        """
